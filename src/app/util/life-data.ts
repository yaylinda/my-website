export class LifeData {
    ...
    constructor() {
        ...
        this.data['childhoodMarker'] = {
            ...
            'subtitle': 'Ages 0-18',
            'content': '- 1994: born in Wuhan, China' + '\n' 
            ...
            + '- 2005: graduated elementary school; started middle school (a new school district)' + '\n'
        ...
        this.data['collegeMarker'] = {
            ...
            'subtitle': 'August 2012 - May 2016\nB.S. Computer Science, Statistics',
            'content': 'Rice University was the school of my dreams. I applied early decision and got accepted! It was the best day of my life thus far. I can still remember the excitement and pure joy of reading that acceptance email. During Orientation Week, (aka the most exhausting week of my life thus far), packed full with games, ice-breakers, talks, lectures, and other introductory activities, I decided to major in Computer Science, and never looked back! During my sophomore year, I decided to pick up a double major in Statistics as well.'
        }
        this.data['internshipsMarker'] = {
            'title': 'Internships',
            'subtitle': 'Summer 2013, 2014, 2015\nA taste of the working life',
        ...
        this.data['capitalOnePart1Marker'] = {
            ...
            'subtitle': 'July 2016 - Present',
            'content': 'My first full-time career!'
        }
        this.data['capitalOnePart2Marker'] = {
            'title': 'The Marketing Navigator Journey',
            'subtitle': 'Deciding to stay at Capital One',
            'content': ''
        }
    }
}